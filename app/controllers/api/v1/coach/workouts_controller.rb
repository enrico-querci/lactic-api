  ...
  module V1
    module Coach
      class WorkoutsController < BaseController
        ...
        def index
          render json: WorkoutBlueprint.render(@week.workouts, locale: current_locale)
        end
        ...
        def create
          ...
          render json: WorkoutBlueprint.render(workout, locale: current_locale), status: :created
        end
        ...
        def update
          ...
          render json: WorkoutBlueprint.render(workout, locale: current_locale)
        end
        ...
        def duplicate
          ...
          render json: WorkoutBlueprint.render(new_workout, view: :extended, locale: current_locale), status: :created
        end
